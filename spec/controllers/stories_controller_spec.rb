  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved story as @story" do
        ...
        post :create, {:story => { "body" => "invalid value" }}, valid_session
        assigns(:story).should be_a_new(Story)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested story" do
        ...
        Story.any_instance.should_receive(:update).with({ "body" => "MyText" })
        put :update, {:id => story.to_param, :story => { "body" => "MyText" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the story as @story" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Story.any_instance.stub(:save).and_return(false)
        put :update, {:id => story.to_param, :story => { "body" => "invalid value" }}, valid_session
        assigns(:story).should eq(story)
      end
